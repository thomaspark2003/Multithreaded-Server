...
def client_pos(sock_conn, sock_addr, client_num, clients_dict):
...
def main():
    ...
    try:
        ...
        while(True):
            ...
            player_thread = threading.Thread(target=client_pos, args=(sock_conn, sock_addr, client_num, clients_dict), daemon=True)
            player_thread.start()
